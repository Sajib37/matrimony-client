                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('type')}  id="type" required>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <input className="w-full rounded-lg" {...register('dob')} type="date"></input>
                            </div>
                            ...
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('height')}  id="type" required>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('weight')}  id="type" required>
                            ...
                            <div className="w-full">
                                ...
                                <TextInput {...register('age')} defaultValue={""}  id="base" type="number" sizing="md" required/>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('occupation')}  id="type" required>
                            ...
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('race')}  id="type" required>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <TextInput {...register('fathersName')} defaultValue={""}  id="base" type="text" sizing="md" required/>
                            </div>
                            <div className="w-full">
                                <div className="mb-1 block">
                                    <Label value="Mothers Name" />
                                </div>
                                <TextInput {...register('mothersName')} defaultValue={""}  id="base" type="text" sizing="md" required/>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('permanentDivision')}  id="type" required>
                            ...
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('presentDivision')}  id="type" required>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            ...
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('partnerHeight')}  id="type" required>
                                    <option value={'default'} disabled>Select Height:</option>
                                    <option value={"150 cm"}>150 cm</option>
                                    <option value={"155 cm"}>155 cm</option>
                                    <option value={"160 cm"}>160 cm</option>
                            ...
                            <div className="w-full">
                                ...
                                <Select defaultValue='default' {...register('partnerWeight')}  id="type" required>
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full">
                                ...
                                <TextInput {...register('partnerAge')} defaultValue={""}  id="base" type="number" sizing="md" required/>
                            </div>
                            <div className="w-full">
                                <div className="mb-1 block">
                                    <Label value="Your Phone:" />
                                </div>
                                <TextInput {...register('phone')} defaultValue={""}  id="base" type="text" sizing="md" required/>
                            </div>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <TextInput {...register('email')} readOnly defaultValue={user.email}  id="base" type="email" sizing="md" required/>
                        </div>
